...
instrument. The aesthetic design develops what was observed by \textcite{mcalpine_sampling_2014} and provides a means to answer to what degree can visual stimuli be leveraged to ``sell'' the experience of playing a DMI. When combined with a passive haptic response, are aethetics enough to convince the player and remove the barrier to verisimilitude.
