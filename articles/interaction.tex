...
This line of enquiry led to following from the work in \texcite{mcpherson_portable_2013, moro_platform_2020}. A
system was created using the Fairchild QRE1113 \footnote{Fairchild, now ON Semiconductor,
QRE1113 datasheet
\url{https://www.onsemi.com/download/data-sheet/pdf/qre1113-d.pdf}}. The QRE1113
is an optical sensor composed of an infrared (IR) LED and a phototransistor sensitive to IR light. The
...
To address this restruction, we looked toward another common application of the QRE1113, which is within line following robots \cite{ramesh_turning_2017}. For line following,
an array of QRE1113s are used in conjunction with low or high reflecant tape. A
motorised system can then use this data to follow the line of tape and adjust
its position. The same principles was used, but rather than single shade, a greyscale gradient was applied to the jack body (Figure~\ref{fig:jack-tags}).
...
After successful deployment at exhibition at San COlombano and verfification that system was robust enough to justify refinement, a second keyboard was commisioned with Roberto Livi.
