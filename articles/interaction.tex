...
\begin{figure}
    \centering
    \frame{\includegraphics[width=0.5\linewidth]{img/drawing-jack_forces.pdf}}\\
...
\begin{figure}
    \centering
    \includegraphics[width=0.35\linewidth]{img/pcb-prototype-schematic.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{img/mark-1-model-cross-section.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{img/plot-hysteresis.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\linewidth]{img/mark-2-front-internal.jpeg}
