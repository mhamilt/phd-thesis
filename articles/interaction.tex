...
\begin{figure}
    \centering
     \includegraphics[width=0.66\linewidth]{img/49-key-leds.png}
...
% A manual visual check of plotted
% all sensors readings confirmed that interference from neighbouring jacks had
% been eliminated. 
% RGB LEDs are placed on the reverse side of the PCB, vertically in-line with the sensors, and were added to provide a programmable means of providing visual feedback. The LEDs are controlled via a pulse width modulation (PWM) signal and are addressable individually. The output signal of the
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{img/49-key-pcbs.jpg}
...
\begin{table}[]
    ...
    \caption{3-bit binary encoding for \texttt{MUX} channel selection}
...
\begin{figure}
    \centering    
    \includegraphics[width=0.6\linewidth]{img/pcb_controller_schematic_v2.pdf}
    \caption{}
    \label{fig:sensor-schematic-1}
\end{figure}
