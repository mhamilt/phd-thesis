...
\begin{itemize}
    \item Haptic: feedback that engages the sense of touch, including tactile (skin) and kinesthetic (force/motion) sensations.
...
\begin{itemize}
    \item ``Haptic (combined senses of touch, including skin vibration and pressure, and the muscle senses of motion, position, and force)'' \cite{cook_remutualizing_2004}. ``Sensory and motor modalities under one unified umbrella'' \cite{rovan_typology_2000}
