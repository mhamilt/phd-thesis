...
Feedback as it refers to physical sensory feedback, the sense of forces, movement, position, and pressure through internal sensory mechanisms


\begin{itemize}
    \item Haptic: feedback that engages the sense of touch, including tactile (skin) and kinesthetic (force/motion) sensations. (Also: tactual \cite{bongers_tactual_1998} when sensed by the skin (cutaneous) \cite{srinivasan_tactual_1996}) ``The word haptics is derived from the Greek word “haptikos,” which refers to “a sense of touch,” and the Oxford English dictionary defines haptics as: “Relating to the sense of touch, in particular relating to the perception and manipulation of objects using the senses of touch and proprioception.”''\cite{culmer_haptics_2020}
    \item Mechanical: haptic feedback using physical movement or structures that apply forces or constraints.
    \item Force: haptic feedback through the physical resistance or force perceived by muscles and joints, allowing users to feel weight, resistance, or motion 
    \item Tactile haptic feedback perceived through skin contact—including sensations like pressure, texture, or vibration—distinct from deeper force sensations.
    \item Vibrotactile: tactile feedback achieved through vibration
...
From the perspective of DMIs

\begin{itemize}
    \item ``Haptic (combined senses of touch, including skin vibration and pressure, and the muscle senses of motion, position, and force)'' \cite{cook_remutualizing_2004}. ``Sensory and motor modalities under one unified umbrella'' \cite{rovan_typology_2000}. ``The term haptic refers to
combined feedback from tactile sensors in the skin and kinesthetic sensors in muscles
and joints.''  \cite{omodhrain_playing_2000}
    \item Mechanical: \textcite{rovan_typology_2000} haptic and mechanical feedback are used interchangeably. ``actuator or mechanical device'' \cite{hayes_vibrotactile_2011}
    \item Force: ``Systems ... to exert large-scale mechanical force back onto the operator.''
    \item Tactile: ``discriminative touch as in the perception of surfaces.'' \cite{rovan_typology_2000}
    \item Vibrotactile: ``vibrating at a given frequency, in contact with the skin at one or several locations \cite{rovan_typology_2000}'' ``Vibrotactile stimulation evokes tactile sensations using mechanical vibration of the skin, typically at frequencies of 10-500 Hz'' \cite{kaczmarek_electrotactile_1991}
    \item Electrotactile: ``stimulation evokes tactile (touch) sensations within the skin at the location of the electrode by passing a local electric current through the skin.'' \cite{kaczmarek_electrotactile_1991}
\end{itemize}
...
Using this taxonomy, defines the interface as a passive haptic, mechanical, tactile interface.


Using the NIME archive as example, as its archive is open access under the CC-BY-4 license

The term `tactual' as it relates to DMI is in  far less use, appearing in 10 papers, mostly as a result of citation to x1\cite{sherrick_scale_1985}, x4\cite{bongers_tactual_1998}, x2\cite{tan_multifinger_1996}

Alongside term haptic with no differentiation:

- \url{https://www.nime.org/proceedings/2002/nime2002_073.pdf}
- \url{https://www.nime.org/proceedings/2013/nime2013_245.pdf}
- \url{https://www.nime.org/proceedings/2015/nime2015_118.pdf}

purely tactual

- \url{https://www.nime.org/proceedings/2002/nime2002_056.pdf} though this lists ``sensory modalities --tactual, kinaesthetic, sonic, auditory'' in which there is some repetition.

Compares to `haptic' which appears in around 300 papers
