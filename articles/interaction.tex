...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{img/sensor_board_v1.pdf}
    \caption{Mark 1 Sensor board schematic. Component labels \texttt{D} correspond to LEDs and \texttt{Q} to optical sensors}
...
sensor boards souldered together with ribbon cable.
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{img/sensor_board_v2.pdf}
    \caption{Mark 2 Sensor board schematic. RGB LEDs \texttt{D}, signal paths \texttt{S}, optical sensors \texttt{Q}. The Solder Junction in the center illustrates the connection  between the multiplexer output and corresponding \texttt{S} channel assignment on the FFC cable.}
