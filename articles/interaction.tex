...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{img/prototype-pcb-bw.png}
    \caption{Enter Caption}
    \label{fig:prototype-pcb}
\end{figure}

A prototype PCB (Figure~\ref{fig:prototype-pcb}) was drafted using the EAGLE CAD software. The prototype PCB is provides combined wiring for the sensors and the microcontroller and provided a proof-of-concept for the optical sensor mounting.
...
of breaking the senro was high.
