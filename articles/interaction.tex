...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{img/hysteresis-states.pdf}
    \caption{Enter Caption}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{img/hysteresis.pdf}
    \caption{Enter Caption}
