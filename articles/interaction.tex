...
Framed typically as a problem for musicians using synthesisers who are being denied an vector of information from which they can draw upon and use to inform and shape expression in performance. The absence of haptic information is also true for instruments that cannot be played such as the musical heritage instruments within musical instrument museum collections.
A major motivation for the design of the interface in this chapter was to overcome this very limitation.
...
harpsichord’s unique tactile and kinaesthetic qualities without risk of damage to the
original artifacts. The interface would aim to offer an immersive learning environment, providing a means to access the instructional value of the Tagliavini collection. 
...
The keyboard provides the haptic feedback that would be present on an original 15th century
harpsichord with two 8-foot registers as is typical of the Italian style \cite{tagliavini_clavicembali_1987}. This new interface builds on the work of \textcite{mcalpine_sampling_2014} with
...
to compromise space for exhibition of the permanent display. The first fully-functing interface is
hosted in the Oratory above the main hall (Figure \ref{fig:installed}) of San Colombano,
alongside unique examples of the Italian Renaissance building tradition,
including the 1547 harpsichord and the 1540 spinet by Alessandro Trasuntino \footnote{https://digital.fondazionecarisbo.it/artwork/arpicordo-a-pianta-poligonale-anonimo-attr-ad-alessandro-trasuntino}.
...
To better contextualise the methodology for the project, this section gives a brief timeline of haptic keyboard projects, the modern history ofwhich could be said to begin with 
...
Trapping here is perhaps in trying to do too much. However, the rise of low-cost electronics at the demonstrated that ``a mass production of an active keyboard is now possible with the proposed approach.''
