...
\begin{itemize}
    ...
    \item Force Feedback: is a subset of haptic feedback achieved through the physical resistance or force perceived by muscles and joints, allowing users to feel weight, resistance, or motion. Examples this would be the FireFader \cite{FireFader} and TorqueTuner \cite{TorqueTuner}.
...
\begin{figure}
    ...
    \caption{An incomplete taxonomy of haptic feedback}
    \label{fig:taxonomy}
\end{figure}
