...
feedback is achieved through heat, sound waves and electrical current
respectively
...
movement principles of the body'' \cite{bokowiec_ritual_2011}. Kinaesthetic
sensation and feedback are also discussed loosely in the NIME archive with the
...
the exception of perhaps the theramin, one could argue that in fact all musical
...
the theramin could be argued that the absence of haptic feedback is a form of
...
This says soethgi about the natureof musical instrument conservation. If these
instruments are degrading both in fragiliyty and sonic qualit, what can be done
to preserve them.

To what degree can visual stimul be leveraged to ``sell'' the experience of
playing an interface. In conjunction with a haptic response, is it enough to
convince the player and remove the barrier to verisimiltude as raised by
...
in \cite{McPherson2013, McPherson2019} function as well the Moog Piano Bar from
