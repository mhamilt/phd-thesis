...
\paragraph{Force Feedback:} A subset of kinaesthetic feedback achieved through the physical resistance or force perceived by muscles and joints, allowing users to feel weight, resistance, or motion. Examples this would be the FireFader \cite{berdahl_firefader_2013} and TorqueTuner \cite{kirkegaard_torquetuner_2020}. \newline
...
Combined Sensor and Controller PCB that allowed a proof of concept scaled up to 7 jacks.
...
Initial designe to bend the legs of THT optical sensor to allow flush mounting to the underside of the wrestplank.

It was found that the legs of the optical sensor were too fragile and the risk of breaking thesenro was high.

Could have been end mounted like \cite{mcpherson_portable_2013} but this would also be time consuming and the use of THT parts in the rest of the design was prohibitive with space.
...
\subsubsection{FRAM}\label{eeprom-nvram-fram}
