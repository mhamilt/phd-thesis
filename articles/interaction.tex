...
\begin{figure}[!b]
  ...
  \begin{subfigure}[h]{0.5\linewidth}
    \centering
    \includegraphics[height=0.2\linewidth]{img/sensor_board_v2}
    \caption{Sensor PCB}
    \label{fig:sensor_v2}
  \end{subfigure}
  \begin{subfigure}[h]{0.4\linewidth}
    \centering
    \includegraphics[height=0.2\linewidth]{img/controller_board_v2}
    \caption{Controller PCB}
    \label{fig:controller_v2}
  \end{subfigure}
  \caption{Redesigns of sensor and controller boards show the inclusion of FFC and JST-PH ports. Sensor board shows the solder pads used to configure its position in the keyboard}
  \label{fig:pcb_v2}
\end{figure}
