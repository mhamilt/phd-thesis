...
% To retain the instructional value of a historical instrument that cannot be played, the kinesthetic actions encoded within the interface must be emulated. Retaining the form of the instrument, such as a commercial MIDI keyboard, is part of achieving successful emulation, as will be discussed in Section~\ref{}. 
...
% performance.  
As part of a broader commitment to accessibility, the Museo San Colombano-Tagliavini Collection, situated within Fondazione Carisbo's cultural itinerary \cite{meer_collezione_2007}, has undertaken a series of projects aimed at enhancing both cognitive and sensory engagement. Supported by funding from NextGenerationEU\footnote{https://openpnrr.it/progetti/143852/}, these initiatives seek to leverage the collection’s rich holdings to create immersive and interactive modes of encounter with the exhibited heritage. Central to this vision is the reinterpretation of historical musical objects through their tactile and auditory dimensions, making the exhibition more inclusive for blind and partially sighted visitors, as well as the general public. The Tagliavini Collection, housed at the Museo San Colombano – Genus Bononiae in Bologna, comprises more than fifty historical keyboard instruments, with a particular concentration on Italian plucked string types. The collection represents a unique resource of interest to musicologists, organologists, and performers. Tagliavini's guiding principle was one of authenticity: instruments were acquired with the explicit aim that they be restored to playing condition with as little intervention as possible. At the same time, their fragility and historical value impose clear limitations: they are played only under carefully controlled conditions, by experienced historical keyboard specialists, or by students under the close supervision of the curator.
...
Retaining the form of the instrument, such as a commercial MIDI keyboard, is one part of achieving successful emulation, as will be discussed in Section~\ref{}. Yet even where the form is preserved, what is missing from such a keyboard is the haptic information of the instrument. 
...
\end{quotation}
Weighted keys represent a partial attempt to reintroduce haptics, imitating the resistive force of, e.g., a piano action. However, such weights only simplify the complexity of the forces involved, neglecting the vibrotactile feedback from the acoustic coupling between soundboard and keybed after hammer strikes, the hammer--key and hammer--key impacts, and the effect of escapement \cite{oboe_mikey_2006,fluckiger_evaluation_2018}. The expressive potential of commercial MIDI interfaces is further limited by their reduction of musical nuance to a single parameter: key attack velocity, which, as \textcite{oboe_mikey_2006} writes:  
\begin{quotation}
  ``constitutes a significant limitation for the musician, who loses expressive control of the instrument and, in turn, of the generated sound.''
\end{quotation}

The behaviour of the sound synthesis engine is determined by the speed at which a key moves from its rest position (or central trigger point) to being fully depressed. For the piano, this mapping remains relatively faithful, as the hammer strike occurs near the bottom of the key’s travel. However, applying the same interface to the harpsichord creates a misrepresentation. On most MIDI keyboards, sound is triggered at the end of the key's motion; in the harpsichord, by contrast, both the primary haptic and sonic events occur midway through, when the player first feels resistance as the plectrum meets the string, and again as the jack body presses against the jack rail. This absence of nuanced haptic feedback is often described as a central challenge for musicians working with synthesisers. Without it, performers are denied the physical grounding that shapes musical expression. 



The same problem applies---perhaps even more profoundly---to historical instruments that can no longer be played. These fragile objects, preserved within museum collections, embody a distinctive fusion of form, function, and history. Their cultural value extends beyond their visual presence, encompassing tactile and auditory dimensions of performance \cite{fritz_listener_2017}. Yet in the museum context, preservation demands frequently outweigh experiential access. Instruments are too often reduced to static artefacts, restricted to visual display under what \textcite{mcalpine_sampling_2014} terms the ``red velvet cord'' approach. While this protects delicate mechanisms, it simultaneously diminishes the functional identity of the objects, depriving visitors of the full cultural and historical resonance inherent in performance. 



This chapter documents the development of two such digital musical instruments (DMIs), beginning with the motivations, constraints, and methodological framework. Subsequent sections trace the design process in chronological order, from the earliest prototypes to the full-scale realisation of the concept. The resulting keyboards reproduce the haptic responses characteristic of an original fifteenth-century harpsichord, featuring two 8-foot registers typical of the Italian style \cite{tagliavini_clavicembali_1987}. In doing so, the work builds on prior explorations in musical heritage \cite{mcalpine_sampling_2014,baldwin_tromba_2016} as well as four decades of research into haptic keyboard design.  

In addition to enhancing the visitor experience within the musical instrument museum, the project engages with a parallel concern: the sustainability of digital research. The optical sensing technique implemented for the keyboard adapts earlier work by McPherson on the piano \cite{mcpherson_portable_2013}. By extending and recontextualising this method, the project ensures that its outcomes endure beyond their immediate scope, aligning with best practices for digital research archiving \cite{smith_software_2016} and addressing long-term considerations for digital musical instruments (DMIs) and electronics hardware \cite{mcpherson_nimehub_2016,fiordelmondo_longevity_2024}. The final design iteration is therefore positioned not only as a practical interface for public engagement, but also as a research probe: a tool to explore the unique characteristics of the harpsichord and their implications for musical performance.  
