...
\caption{Sketch of the finite difference method discretising the plate equation. On the left, the 13-point biharmonic coefficients are scaled by $h^{-4}$\cite{tee_a-novel_1963}.}\label{fig:PlateFD}
\end{figure}
