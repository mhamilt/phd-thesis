...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{img/bhblocks.pdf}
    \caption{Biharmonic divided into diagonal subblocks.}
...
In its discrete form the biharmonic operator has coefficients that can be arranged in a stencil forming the matrix in Figure~\ref{fig:biharmonic-stencil}. This leaves the boundary conditions which result in a multi-diagonal matrix  For an in-depth formulation of the discrete biharmonic, see \textcite[Chapters 10-12]{bilbao_numerical_2009}.
...
\caption{Ghost points resulting from applying the biharmonic difference operator to the upper-left corner.}\label{fig:fdtd-plate-ghost}
\end{figure} 
