...
\begin{itemize}
    ...
    \item Usage of such a toolkit in Musical Instrument Conservation for retrieving material properties un invqsievly    
    \item software suatainability of a toolkit (conserving the tools for conservation) Methodology and execution
    \item generlised structure of a digital toolkit
\end{itemize}
