...
\begin{table}
    ...
    \end{tabular}
    \caption{A comparison of eigen solver output given the conditions in Figure~\ref{fig:parameters}}
    \label{tab:eig-comp}
\end{table}
...
\begin{figure}
    \centering
    % \includegraphics[width=0.5\linewidth]{}
    \caption{Compute time of increasing sized biharmonic in MATLAB, Python and C++.}
...
\begin{figure}
    \centering
    % \includegraphics[width=0.5\linewidth]{}
    \caption{Compute time for shift-invert eigen solver with increasing number of modes in MATLAB, Python and C++. System used is giving by the parameters in Figure~\ref{fig:benchmark_parameters}.}
    \label{fig:eigensolver-performance}
\end{figure}
