...
\end{equation}
and note that the energy is strictly decreasing when the source is inactive ($f(t) = 0$). To ensure numerical stability in the presence of non-linear terms, the system is reformulated using the Scalar Auxiliary Variable (SAV) method \cite{bilbao_explicit_2023, van-walstijn_real-time_2016}:
\begin{equation}
...
A detailed description can be found in \cite{bilbao_real-time_2024, russo_noniterative_2025}.
