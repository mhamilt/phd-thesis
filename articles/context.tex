...
Aurora is free digital software but its source code has not historically been open.
...
For a brief illustration in use, three projects referencing Aurora since 2011.

\url{https://www.ioa.org.uk/system/files/acoustics_bulletin_march-april_2021.pdf} used aurora in 2021
\url{https://era.ed.ac.uk/bitstream/handle/1842/36988/Shannan2020.pdf} a 2019 PhD thesis
\url{https://core.ac.uk/reader/13782570} PhD thesis

Versions can be inferred from use dates, but not an accurate versioning system.

The compiled binaries exist on the Farina's own website with the note:

\cite{farina_aurora_2025}
...
A variation of Aurora used the Audacity FOSS audio software. Since Audacity was open source the Aurora software could be embedded directly through an experimental module system \url{https://manual.audacityteam.org/man/modules.html} which is both under documented and supported.

A drawback of this approach is that the aurora software is entangled within the source code of Audacity. Breaking changes -- updates to the source code that break the functionality of other code -- were inevitable, with Aurora relying on older versions of Audacity to function. 
...
Lessons learned from this and best practice suggest to take a separate library / interface approach which has guided the structure of Magpie.
