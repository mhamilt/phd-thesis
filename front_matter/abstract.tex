...
through the creation of a two-register haptic interface constructed from a
custom-built, historically informed harpsichord keyboard that provides the same
...
C\textsc{++}. \textsc{magpie} aims to democratise access to acoustic modelling,
